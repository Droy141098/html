...
function displayCart() {
    ...
    cart.forEach(i => {
        ...
        Minus.innerHTML =
            "<button class='btn btn-danger float-right' onclick = 'minus(" +
            i.id +
            ")'>-</button>";
        Count.innerHTML =
        ...
        Plus.innerHTML =
            "<button class='btn btn-danger float-left' onclick = 'plus(" +
            i.id +
            ")'>+</button>";
...
function knowMore(num) {
    ...
    //     `<button type="button" class="btn btn-danger btn-sm float-right" id="a2c`
    //     +book[i].id+
    //     `" " onclick="add2cart(`
    //     +book[i].id+
